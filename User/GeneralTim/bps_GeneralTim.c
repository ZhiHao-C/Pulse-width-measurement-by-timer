...
static void NVIC_Config(void)
{
	...
	//不管是更新中断还是捕获中断都包含在TIM5_IRQn中
	NVIC_InitStruct.NVIC_IRQChannel=GENERAL_TIM_IRQ;//设置中断来源
	NVIC_InitStruct.NVIC_IRQChannelPreemptionPriority=1;             //改
...
/*--------------------输入捕获结构体初始化-------------------*/	
	...
	// 清除TIMx的挂起标志。
  TIM_ClearFlag(GENERAL_TIM, TIM_FLAG_Update|TIM_FLAG_CC1);	                //改
  // 开启更新和捕获中断  
